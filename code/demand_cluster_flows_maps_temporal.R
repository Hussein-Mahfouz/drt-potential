...
#
# if(save == TRUE){
#   tmap_save(tm = map_cluster_results, filename = paste0(plots_path, "map_clusters_scenario_", scenario, "_", day_time, "_", clustering, "_length_", distance_threshold, "_.png"), width = 12, dpi = 1080, asp = 0)
# }
...
# Combine cluster polygons
clusters_vis_mode_poly_filt3_all = clusters_vis_mode_poly_filt3 %>%
  mutate(area = st_area(.)) %>%
...
tm_shape(clusters_vis_mode_poly_filt3_all) +
  tm_borders(col = "darkgreen",
             lwd = 3.5,
             lty = "dashed") +
  tm_layout(fontfamily = 'Georgia',
