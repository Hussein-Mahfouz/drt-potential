...
![Clustering OD pairs with poor PT supply (Scenario 2)](images/map_clusters_scenario_2_equal_bus_frac_grouped.png){#fig-cluster-scenario-2-equal-bus-frac}
...
![](images/map_clusters_scenario_3_equal_bus_frac_grouped.png){#fig-cluster-scenario-3-equal-bus-frac}

![](images/map_clusters_scenario_3_equal_length_10000_bus_frac_grouped.png){#fig-cluster-scenario-3-equal-bus-frac-length-1000}

# Discussion

-   different clustering algorithms (optics, hdbscan ...)

-   spatiotemporal clustering

-   bivariate clusters based on disaggregated data
