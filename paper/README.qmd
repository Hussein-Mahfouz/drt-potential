...
![](images/figure_bar_urban_rural_compare_filter_no_filter_facet_cluster_scenario_3_length_50000.png){width="310"}

![](images/figure_scatter_commuters_color_speed_facet_cluster_scenario_3_length_50000.png){width="310"}
...
@fig-zones-one-map gives an overview of how the zones could be merged based on the needs of the different clusters. It becomes more clear that the zones are predominantly in rhe outskirts and in rural areas. Zones in urban area, such as that in the South West covers an area with no public transport. Future work could explore where bus services could be added instead of taking the bus network as a fixed constraint [@pinto2020joint].
