...
![Urban Rural Classification for the city of Leeds](images/rural_urban_bus.png){#fig-rural-urban alt="Urban Rural Classification - 1: most rural, 10: most urban" fig-align="center" width="80%"}
...
![Classification of areas covered by each cluster and the DRT zone extracted from it](images/figure_bar_urban_rural_compare_filter_no_filter_facet_cluster_scenario_3_length_50000.png){#fig-cluster-stats-1 width="78%"}

![Total commuters on the different OD pairs making up each cluster](images/figure_scatter_commuters_color_speed_facet_cluster_scenario_3_length_50000.png){#fig-cluster-stats-2 width="78%"}
