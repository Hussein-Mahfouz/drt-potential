...
The shift from tradiditonal 4-step models to activity-based transport models opens up many exciting research areas. Developing tools and pipelines for generating activity based models can allow us to:
